...
//       "studentProfile.registrationStatus": "Completed",
//     });
...
//     });
//   } catch (err) {
//     console.error("Error loading assign courses:", err);
//     req.flash("error_msg", "Failed to load assignment page.");
//     res.redirect("/dashboard/dean");
//   }
// };
...
//         $in: ["Registered", "Approved", "Fully Admitted"],
//       },
//     });
...
//     req.flash("success_msg", "Courses assigned successfully!");
...
//     res.render("dean/assignCourses", {
//       title: "Assign Courses - Copperstone University", // Add title here
//       students,
//       courses,
//       messages: {
...
//       return res.redirect("/dean/assign-courses"); // Fixed route consistency
//     }
...
//     );
//     res.redirect("/dean/assign-courses"); // Fixed route consistency
//   } catch (error) {
